...
function Get-NonPersistentAzureADDevice
{
	...
	Write-Verbose "Pulling list of Azure AD devices. This may take a few minutes."
...
function Select-StaleAzureADDevice
{
	...
	Write-Verbose "Grouping duplicate device objects. This may also take a few minutes."
...
# Wrap Remove-AzureADDevice to implement ShouldProcess
...
if ($DeviceLimit -and ($DeviceLimit -gt $staleNonPersistents.Count)) 
{
...
# call Remove-AzureADDevice wrapper function (implements -WhatIf/-Confirm)
